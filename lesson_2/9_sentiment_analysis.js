...
function sentiment(text) {
  let words = text.toLowerCase().split(/[^a-z']/gi);
  let positiveCount = 0;
  ...
  let overallSentiment = determineOverallSentiment(positiveCount, negativeCount);
  

  logOutput(positiveCount, positiveSentiments, negativeCount, negativeSentiments, overallSentiment);
}

function logOutput(positiveCount, positiveSentiments, negativeCount, negativeSentiments, overallSentiment) {
...
function determineOverallSentiment(positiveCount, negativeCount) {
